...
let
  inherit (lib) attrsets meta trivial;
    ...
    mimeApps.defaultApplications =
      attrsets.concatMapAttrs
        ...
        (
          ...
          {
            application = {
              x-extension-htm = browsers;
              x-extension-html = browsers;
              x-extension-shtml = browsers;
              x-extension-xht = browsers;
              x-extension-xhtml = browsers;
              "xhtml+xml" = browsers;
            };
